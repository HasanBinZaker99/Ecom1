      ...
      <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <form class="forms-sample" action=" {{ url('admin/update-admin-password') }} " method="POST" name="updateAdminPasswordForm" id="updateAdminPasswordForm">
              @csrf
              ...
              <div class="form-group">
                ...
                <input type="password" class="form-control" name="confirm_password" id="ConfirmPassword" placeholder="Enter Confirm Password" required>
              </div>
